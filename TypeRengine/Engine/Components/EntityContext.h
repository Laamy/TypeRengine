...
public: // constructor stuff
	__forceinline EntityContext(entt::basic_registry<entt::entity>* registry) {
		// setup the context
		this->EnttRegistry = registry;
		this->EntityId = this->EnttRegistry->create();
	};

	__forceinline EntityContext() {};
...
public: // quick utils
	...
	*/
	...
	__forceinline bool hasComponent() {
		return this->EnttRegistry->all_of<T>(this->EntityId);
	};
	...
	__forceinline bool isValid() {
		return this->EnttRegistry->valid(EntityId);
	}
};
